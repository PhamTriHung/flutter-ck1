        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: EnglishAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      EnglishAppTheme.nearlyDarkBlue.withOpacity(0.2),
                      EnglishAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: EnglishAppTheme.nearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      EnglishAppTheme.nearlyDarkBlue.withOpacity(0.4),
                      EnglishAppTheme.nearlyDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: EnglishAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: EnglishAppTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/english_app/bottle.png"),
                ),
              ],
            )
          ],
